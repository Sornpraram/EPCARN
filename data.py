...
def get_training_set(data_dir, nFrames, upscale_factor, data_augmentation, other_dataset, patch_size, future_frame):
    return DatasetFromFolder(data_dir, nFrames, upscale_factor, data_augmentation, other_dataset, patch_size, future_frame, transform=transform())
'''
def get_realtime_set(data_dir, nFrames, upscale_factor, data_augmentation, file_list, other_dataset, patch_size, future_frame):
